<template>
  ...
  >
    <li class="grid-content el-button-group">
      <el-button
        v-if="state.isSortTime === 'basic'"
        type="primary"
        icon="el-icon-sort"
        @click="clickFirstTimeSort"
        >시간</el-button
      >
      <el-button
        v-else-if="state.isSortTime"
        type="primary"
      ...
      >
      <el-button
        v-if="state.isSortTitle === 'basic'"
        type="primary"
        icon="el-icon-sort"
        @click="clickFirstTitleSort"
        >제목</el-button
      >
      <el-button
        v-else-if="state.isSortTitle"
        type="primary"
        icon="el-icon-sort-up"
        @click="clickTitleSort"
        >제목</el-button
      >
      <el-button
        v-else
    ...
    <li
      v-for="i in state.responseConference.length"
...
export default {
  ...
  setup() {
    ...
    const state = reactive({
      ...
      errorMessage:
        "존재하는 컨퍼런스가 없습니다. 새롭게 컨퍼런스를 생성하시거나 다른 제목으로 컨퍼런스를 검색해주세요.",
      errTest: [],
      isLastPage: false
    });
    watch(
